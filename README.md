# PIC32CXBZ2 WBZ45xH BLE UART WITH E-PAPER DISPLAY
...
| TOOLS | QUANTITY |
| :- | :- |
| [WBZ451HPE Curiosity Board](https://www.microchip.com/en-us/development-tool/ev79y91a) | 1 |
...
### Getting started with E-PAPER DISPLAY with WBZ451HPE CURIOSITY BOARD.
...
- In your MPLAB Harmony v3 based application go to "firmware\src\app.h" and do the following changes.
	...
	- Copy & Paste the Code in [app.h](https://github.com/MicrochipTech/PIC32CXBZ2_WBZ45xH_BLE_UART_E_PAPER_DISPLAY/blob/main/firmware/src/app.h)

- In your MPLAB Harmony v3 based application go to "firmware\src\app.c" and do the following changes.

	- Copy & Paste the Code in [app.c](https://github.com/MicrochipTech/PIC32CXBZ2_WBZ45xH_BLE_UART_E_PAPER_DISPLAY/blob/main/firmware/src/app.c)
...
- After programming the board, the expected application behavior is shown in the below [video](https://github.com/MicrochipTech/PIC32CXBZ2_WBZ45xH_BLE_UART_E_PAPER_DISPLAY/blob/main/docs/Working_Demo.gif).
